...
class BotonesPage extends StatelessWidget {
  ...
  Widget _botonesRedondeados(){
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.pinkAccent,Icons.shopping_basket,'Buy'),
        ...
        TableRow(
          children: [
            ...
            _crearBotonRedondeado(Colors.green,Icons.bubble_chart,'Chat')
          ]
        ),
        TableRow(
          children: [
  ...
  Widget _crearBotonRedondeado(Color color,IconData icono,String texto){
    ...
    return Container(
          ...
          decoration: BoxDecoration(
            color:Color.fromRGBO(62, 66, 107, 0.92),
